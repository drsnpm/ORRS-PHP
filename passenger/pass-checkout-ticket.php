...
if (isset($_POST['train_fare_checkout'])) {
    if (isset($_SESSION['train_fare_checkout_clicked_time']) && (time() - $_SESSION['train_fare_checkout_clicked_time']) <= 10) {
        $err = "Ticket already paid! Please proceed to confirm your payment";
    } else {
        $_SESSION['train_fare_checkout_clicked_time'] = time();
        ...
        if ($stmt->execute()) {
            ...
            echo "<script>setTimeout(function() { window.location.href = 'pass-train-checkout-ticket.php'; }, 3000);</script>";
        } else {
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly  value="<?php echo $row->pass_train_route;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Departure Date</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly  value="<?php echo $row->pass_dep_date;?>" id="inputText3" >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Departure Time</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly  value="<?php echo $row->pass_dep_station_time;?>" id="inputText3" >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Arrival Time</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly  value="<?php echo $row->pass_arr_station_time;?>" id="inputText3">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" value = "<?php echo $row->pass_fare_payment_code;?>" name= "pass_fare_payment_code"  id="inputText3" type="text" required>
                      </div>
                    </div>

                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-success" value ="Checkout" name = "train_fare_checkout" type="submit" onclick="disableButton()">
