<?php
    ...
    if(isset($_POST['Update_Profile'])){
      if (isset($_SESSION['Update_Profile_clicked_time']) && (time() - $_SESSION['Update_Profile_clicked_time']) <= 10) {
        $err = "Your Profile has already been Updated";
    } else {
        $_SESSION['Update_Profile_clicked_time'] = time();
                  ...
                  <form method ="POST">
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="pass_fname" value="<?php echo $row->pass_fname;?>" id="inputText3" type="text" pattern="[A-Za-z]+" minlength="4" reruired>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3"> Last Name</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="pass_lname" value="<?php echo $row->pass_lname;?>" id="inputText3" type="text" pattern="[A-Za-z]+" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3"> Phone Number</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="pass_phone" value="<?php echo $row->pass_phone;?>" id="inputText3" type="text" minlength="10" maxlength="10" pattern="[0-9]+" required>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="pass_email" value="<?php echo $row->pass_email;?>" id="inputText3" type="email" pattern="^[a-zA-Z0-9]+@gmail.com$" required>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="pass_bday" value="<?php echo $row->pass_bday;?>" id="inputText3" type="date" max="<?php echo date('Y-m-d'); ?>" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3"> Bio</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <textarea class="form-control" name="pass_bio"  id="inputText3" type="text" required><?php echo $row->pass_bio;?></textarea>
                      </div>
                    </div>
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-success" value ="Update Profile" name = "Update_Profile" type="submit" onclick="disableButton()">
